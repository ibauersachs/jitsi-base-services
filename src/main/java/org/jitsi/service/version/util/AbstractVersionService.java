...
/**
 * Base implementation of {@link VersionService} that uses major, minor
    ...
    implements VersionService
{
    ...
    /**
     * Returns a Version instance corresponding to the {@code version}
     * string.
     *
     * @param version a version String that we have obtained by calling a
     *   {@link Version#toString()} method.
     * @return the {@link Version} object corresponding to the
     *   {@code version} string rr null if we cannot parse the string.
     */
    ...
    /**
     * Creates new {@link Version} instance specific to current implementation.
     * @param majorVersion major version number.
     * @param minorVersion minor version number.
     * @param nightlyBuildId nightly build id string.
     * @return new {@link Version} instance specific to current implementation
