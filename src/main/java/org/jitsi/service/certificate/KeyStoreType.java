...
public class KeyStoreType
{
     ...
     * @param hasKeyStorePassword {@code true} if the keystore supports
     *                           passwords, {@code false} otherwise.
     */
     ...
     * @return {@code true} if the keystore supports passwords, {@code false}
     *         otherwise.
     */
