...
public class PacketLoggingConfiguration
{
     ...
     * @return {@code true} if packet logging is enabled.
     */
     ...
     * Checks whether packet logging is enabled in the configuration
     * for sip protocol.
     * @return {@code true} if packet logging is enabled for sip protocol.
     */
     ...
     * Checks whether packet logging is enabled in the configuration
     * for jabber protocol.
     * @return {@code true} if packet logging is enabled for jabber protocol.
     */
     ...
     * Checks whether packet logging is enabled in the configuration
     * for RTP.
     * @return {@code true} if packet logging is enabled for RTP.
     */
     ...
     * Checks whether packet logging is enabled in the configuration
     * for Ice4J.
     * @return {@code true} if packet logging is enabled for Ice4J.
     */
     ...
     * arbitrary packets.
     *
     * @return {@code true} if packet logging is enabled for arbitrary packets.
     */
     ...
     * @param enabled {@code true} if we enable it.
     */
